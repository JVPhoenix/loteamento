...
interface AdminUpdateReservationInterface {
...
export default function AdminUpdateReservation(props: AdminUpdateReservationInterface) {
  ...
  const [reservedContact, setReservedContact] = useState<string | null>(props.selectedItem.reservedForContact);
  ...
  return (
    <>
      ...
      <h1 className="text-gray1 text-xl response:text-2xl font-normal select-none m-2">Deseja editar esta reserva?</h1>
